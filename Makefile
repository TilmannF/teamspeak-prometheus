...
.PHONY: help setup lint format check test test-smoke run-fake docker-build docker-test clean
...
help:
	...
	@echo "docker-test   build the image, test its HEALTHCHECK and shutdown"
...
docker-test: docker-build
	tests/container_test.sh teamspeak-prometheus:dev
